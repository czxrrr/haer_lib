...
import com.hasi.haer_lib.CustomApplcation;
import com.hasi.haer_lib.R;
import com.hasi.haer_lib.bean.User;
import com.hasi.haer_lib.util.CollectionUtils;
import com.hasi.haer_lib.view.HeaderLayout;
import com.hasi.haer_lib.view.HeaderLayout.HeaderStyle;
import com.hasi.haer_lib.view.HeaderLayout.onLeftImageButtonClickListener;
import com.hasi.haer_lib.view.HeaderLayout.onRightImageButtonClickListener;
import com.hasi.haer_lib.view.dialog.DialogTips;
...
/**
 * Activity的基类，提供基本功能和框架
 * 提供showToast(), showLog(), showOfflineDialogue(), startAnimActivity()(简化版的startActivity())
 * 提供框架函数initTopbarForBoth(), initTopbarForLeft()以初始化顶端工具栏
 * 提供更新用户信息（好友列表+地理位置）的函数updateUserInfo()
 * by VkaZas 2015.7.24 20:48
 */
	...
	public void showOfflineDialog(final Context context) {
		...
		dialog.SetOnSuccessListener(new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialogInterface, int userId) {
				...
				startActivity(new Intent(context, LoginActivityElinc.class));
				finish();
